...
| C-061 | A freeform reason string alone is sufficient evidence to quarantine or release a learned association. | REJECTED_AS_COLLAPSE | review decisions require exact-revision evidence assessments |
